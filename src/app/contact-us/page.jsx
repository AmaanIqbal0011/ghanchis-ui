  ...
  return (
    <>
      ...
      <main className="min-h-screen w-full bg-white dark:bg-black text-black dark:text-white flex flex-col items-center">
        ...
        {/* Contact Info + Form */}
        <section className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 rounded-lg bg-white dark:bg-black border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500"
                  required
                />
              </div>
